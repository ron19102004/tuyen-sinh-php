<div class="px-4 pt-16 mx-auto w-full md:px-24 lg:px-8 bg-[#bb2033] text-white text-base md:text-lg">
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
        ...
        <div class="space-y-2 ">
            <p class=" font-bold tracking-wide ">Liên hệ</p>
            <div class="flex">
                <p class="mr-1 ">Số điện thoại:</p>
                <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
                    <!-- phone number -->
                    <?php echo Env::get("contacts")["phone"]; ?>
                </a>
            </div>
            <div class="flex">
                ...
                <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
                    <!-- email -->
                    <?php echo Env::get("contacts")["email"]; ?>
                </a>
            </div>
            <div class="flex">
                <p class="mr-1 ">Địa chỉ:</p>
                <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
                    <!-- address  -->
                    <?php echo Env::get("contacts")["address"]; ?>
                </a>
            </div>
        </div>
        <div>
            <span class=" font-bold tracking-wide ">Mạng xã hội</span>
            <div class="flex items-center mt-1 space-x-3">
                <a href="<?php echo Env::get("contacts")["social"]["twitter"]; ?>" class=" transition-colors duration-300 hover:text-deep-purple-accent-400" data-aos="flip-left">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
                        <path
                            d="M24,4.6c-0.9,0.4-1.8,0.7-2.8,0.8c1-0.6,1.8-1.6,2.2-2.7c-1,0.6-2,1-3.1,1.2c-0.9-1-2.2-1.6-3.6-1.6 c-2.7,0-4.9,2.2-4.9,4.9c0,0.4,0,0.8,0.1,1.1C7.7,8.1,4.1,6.1,1.7,3.1C1.2,3.9,1,4.7,1,5.6c0,1.7,0.9,3.2,2.2,4.1 C2.4,9.7,1.6,9.5,1,9.1c0,0,0,0,0,0.1c0,2.4,1.7,4.4,3.9,4.8c-0.4,0.1-0.8,0.2-1.3,0.2c-0.3,0-0.6,0-0.9-0.1c0.6,2,2.4,3.4,4.6,3.4 c-1.7,1.3-3.8,2.1-6.1,2.1c-0.4,0-0.8,0-1.2-0.1c2.2,1.4,4.8,2.2,7.5,2.2c9.1,0,14-7.5,14-14c0-0.2,0-0.4,0-0.6 C22.5,6.4,23.3,5.5,24,4.6z"></path>
                    </svg>
                </a>
                <a href="<?php echo Env::get("contacts")["social"]["instagram"]; ?>" class=" transition-colors duration-300 hover:text-deep-purple-accent-400" data-aos="flip-left">
                ...
                <a href="<?php echo Env::get("contacts")["social"]["facebook"]; ?>" class=" transition-colors duration-300 hover:text-deep-purple-accent-400" data-aos="flip-left">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
                        <path
